...
CREATE TABLE `animation` (
  ...
  KEY `FK8fbr01nl1g51tgjpfgssrepk` (`referrerID`),
  CONSTRAINT `FK8fbr01nl1g51tgjpfgssrepk` FOREIGN KEY (`referrerID`) REFERENCES `user` (`id`),
...
CREATE TABLE `animation_type` (
  ...
  KEY `FKna3pil6sfkj0rsctiudqhoepo` (`typeID`),
  CONSTRAINT `FKna3pil6sfkj0rsctiudqhoepo` FOREIGN KEY (`typeID`) REFERENCES `type` (`id`),
  CONSTRAINT `FKrpqq79nxbpwj61u3f6fm6gxu2` FOREIGN KEY (`animationID`) REFERENCES `animation` (`id`),
...
CREATE TABLE `attitude` (
  ...
  `updateTime` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `userID` (`userID`,`animationID`),
  KEY `FK23qbhws2tyq9s33jiigs275vg` (`animationID`),
  CONSTRAINT `FK23qbhws2tyq9s33jiigs275vg` FOREIGN KEY (`animationID`) REFERENCES `animation` (`id`),
  CONSTRAINT `FKghjdxwahquoj5hw0caylvlwwa` FOREIGN KEY (`userID`) REFERENCES `user` (`id`),
...
CREATE TABLE `comment` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `userID` (`userID`,`animationID`,`comment`),
  KEY `FKmkjdwejvfw0j7q3ukw3a8qpu6` (`animationID`),
  CONSTRAINT `FKe7pshbkin4984x23q4wboi5ka` FOREIGN KEY (`userID`) REFERENCES `user` (`id`),
  CONSTRAINT `FKmkjdwejvfw0j7q3ukw3a8qpu6` FOREIGN KEY (`animationID`) REFERENCES `animation` (`id`),
  CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `user` (`id`),
  CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`animationID`) REFERENCES `animation` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_type` (
  ...
  KEY `FKqffuq7i2v6m05iioox8l7mjt2` (`typeID`),
  CONSTRAINT `FK9yg4rx8f2b8flesopjt80m7uc` FOREIGN KEY (`userID`) REFERENCES `user` (`id`),
  CONSTRAINT `FKqffuq7i2v6m05iioox8l7mjt2` FOREIGN KEY (`typeID`) REFERENCES `type` (`id`),
...
-- Dump completed on 2019-11-19  2:03:24
