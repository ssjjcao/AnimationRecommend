...
CREATE TABLE `animationconnecttype` (
  ...
  KEY `typeID` (`typeID`),
  CONSTRAINT `animationconnecttype_ibfk_1` FOREIGN KEY (`animationID`) REFERENCES `animation` (`id`),
  CONSTRAINT `animationconnecttype_ibfk_2` FOREIGN KEY (`typeID`) REFERENCES `type` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `animationconnecttype`
--

LOCK TABLES `animationconnecttype` WRITE;
/*!40000 ALTER TABLE `animationconnecttype` DISABLE KEYS */;
INSERT INTO `animationconnecttype` VALUES (1,4,'2019-11-18 07:29:50','2019-11-18 07:29:50'),(2,1,'2019-11-18 07:29:50','2019-11-18 07:29:50'),(2,7,'2019-11-18 07:29:51','2019-11-18 07:29:51'),(3,1,'2019-11-18 07:29:51','2019-11-18 07:29:51'),(3,3,'2019-11-18 07:29:51','2019-11-18 07:29:51'),(4,1,'2019-11-18 07:29:51','2019-11-18 07:29:51'),(5,1,'2019-11-18 07:29:51','2019-11-18 07:29:51'),(5,7,'2019-11-18 07:29:51','2019-11-18 07:29:51'),(6,6,'2019-11-18 07:29:52','2019-11-18 07:29:52'),(7,7,'2019-11-18 07:29:52','2019-11-18 07:29:52'),(8,6,'2019-11-18 07:29:52','2019-11-18 07:29:52'),(9,1,'2019-11-18 07:29:52','2019-11-18 07:29:52'),(10,3,'2019-11-18 07:29:52','2019-11-18 07:29:52'),(11,9,'2019-11-18 07:29:52','2019-11-18 07:29:52'),(12,1,'2019-11-18 07:29:52','2019-11-18 07:29:52'),(12,3,'2019-11-18 07:29:52','2019-11-18 07:29:52'),(13,4,'2019-11-18 07:29:52','2019-11-18 07:29:52'),(13,6,'2019-11-18 07:29:52','2019-11-18 07:29:52'),(14,7,'2019-11-18 07:29:53','2019-11-18 07:29:53'),(15,3,'2019-11-18 07:29:53','2019-11-18 07:29:53'),(16,9,'2019-11-18 07:29:53','2019-11-18 07:29:53'),(17,4,'2019-11-18 07:29:53','2019-11-18 07:29:53'),(18,1,'2019-11-18 07:29:53','2019-11-18 07:29:53'),(19,10,'2019-11-18 07:29:53','2019-11-18 07:29:53'),(20,3,'2019-11-18 07:29:53','2019-11-18 07:29:53'),(21,6,'2019-11-18 07:29:53','2019-11-18 07:29:53'),(21,7,'2019-11-18 07:29:53','2019-11-18 07:29:53'),(21,11,'2019-11-18 07:29:53','2019-11-18 07:29:53'),(22,12,'2019-11-18 07:29:53','2019-11-18 07:29:53'),(23,6,'2019-11-18 07:29:54','2019-11-18 07:29:54'),(24,4,'2019-11-18 07:29:54','2019-11-18 07:29:54'),(25,13,'2019-11-18 07:29:54','2019-11-18 07:29:54'),(26,1,'2019-11-18 07:29:54','2019-11-18 07:29:54'),(26,3,'2019-11-18 07:29:54','2019-11-18 07:29:54'),(27,3,'2019-11-18 07:29:54','2019-11-18 07:29:54'),(28,1,'2019-11-18 07:29:54','2019-11-18 07:29:54'),(28,4,'2019-11-18 07:29:54','2019-11-18 07:29:54'),(30,6,'2019-11-18 07:29:54','2019-11-18 07:29:54');
/*!40000 ALTER TABLE `animationconnecttype` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `userattitudetoanimation`
--

DROP TABLE IF EXISTS `userattitudetoanimation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `userattitudetoanimation` (
  `userID` int(11) NOT NULL,
  `animationID` int(11) NOT NULL,
  ...
  KEY `animationID` (`animationID`),
  CONSTRAINT `userattitudetoanimation_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `user` (`id`),
  CONSTRAINT `userattitudetoanimation_ibfk_2` FOREIGN KEY (`animationID`) REFERENCES `animation` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `userattitudetoanimation`
--

LOCK TABLES `userattitudetoanimation` WRITE;
/*!40000 ALTER TABLE `userattitudetoanimation` DISABLE KEYS */;
/*!40000 ALTER TABLE `userattitudetoanimation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `userconnecttype`
--

DROP TABLE IF EXISTS `userconnecttype`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `userconnecttype` (
  `userID` int(11) NOT NULL,
  `typeID` int(11) NOT NULL,
  `createTime` timestamp NOT NULL DEFAULT current_timestamp(),
  `updateTime` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  ...
  KEY `typeID` (`typeID`),
  CONSTRAINT `userconnecttype_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `user` (`id`),
  CONSTRAINT `userconnecttype_ibfk_2` FOREIGN KEY (`typeID`) REFERENCES `type` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `userconnecttype`
--

LOCK TABLES `userconnecttype` WRITE;
/*!40000 ALTER TABLE `userconnecttype` DISABLE KEYS */;
/*!40000 ALTER TABLE `userconnecttype` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-11-18 15:53:28
